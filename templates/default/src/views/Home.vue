...
<template>
  <div class="mx-auto max-w-5xl px-4 py-16 sm:py-24">
    ...
    <div class="text-center animate-fade-in-up motion-reduce:animate-none">
      ...
      <p class="mx-auto mt-6 max-w-2xl text-base leading-relaxed text-gray-400">
        {{ t("home.subtitle") }}
      </p>
      ...
      <div class="mt-10 flex flex-wrap items-center justify-center gap-2">
        <span
          ...
          :key="chip"
          class="rounded-lg border border-white/10 bg-white/[0.04] px-3 py-1.5 text-xs text-gray-400 transition hover:border-emerald-300/30 hover:text-emerald-200"
    ...
    <div class="mt-6 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:mt-10">
      ...
      >
        <div class="flex items-start gap-4">
          <span
            class="grid h-11 w-11 shrink-0 place-items-center rounded-xl bg-gradient-to-br from-emerald-400/20 to-teal-500/20 text-lg text-emerald-200 ring-1 ring-white/10 transition group-hover:from-emerald-400/30"
          >
          ...
          <div>
            ...
            <p class="mt-1 text-sm leading-relaxed text-gray-400">{{ f.desc }}</p>
          </div>
        </div>
      </GlassCard>
    </div>
    ...
    <!-- Bottom CTA -->
    <div class="relative mt-14 overflow-hidden rounded-2xl border border-white/10 p-8 sm:p-12 animate-fade-in-up motion-reduce:animate-none">
      <div class="absolute inset-0 -z-10 bg-[#0d1520]"></div>
      ...
      <div class="relative text-center">
        ...
        <p class="mx-auto mt-2 max-w-lg text-sm text-gray-400">{{ t("home.cta.subtitle") }}</p>
        <RouterLink
          v-if="!auth.userToken"
          to="/register"
